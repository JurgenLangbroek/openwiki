...
export const OPENWIKI_GLEAN_ACCESS_TOKEN_ENV_KEY =
  "OPENWIKI_GLEAN_ACCESS_TOKEN";
export const OPENWIKI_GLEAN_BACKEND_URL_ENV_KEY = "OPENWIKI_GLEAN_BACKEND_URL";
export const OPENWIKI_GLEAN_CLIENT_ID_ENV_KEY = "OPENWIKI_GLEAN_CLIENT_ID";
export const OPENWIKI_GLEAN_EMAIL_ENV_KEY = "OPENWIKI_GLEAN_EMAIL";
export const OPENWIKI_GLEAN_INSTANCE_ENV_KEY = "OPENWIKI_GLEAN_INSTANCE";
export const OPENWIKI_GLEAN_REFRESH_TOKEN_ENV_KEY =
  "OPENWIKI_GLEAN_REFRESH_TOKEN";
export const OPENWIKI_GLEAN_TOKEN_EXPIRES_AT_ENV_KEY =
  "OPENWIKI_GLEAN_TOKEN_EXPIRES_AT";
export const OPENWIKI_GLEAN_TOKEN_TYPE_ENV_KEY = "OPENWIKI_GLEAN_TOKEN_TYPE";
